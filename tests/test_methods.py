...
class TestOfMethods(unittest.TestCase):
    ...
    def test_upload_image_method(self):
        ...
        self.assertIn('.jpg', upload_image(base64file))

    def test_mini_flag_filepath_method(self):
        selection = 'de'
